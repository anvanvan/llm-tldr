...
# Fake embedding dimension (matches the sibling parse-skip suite).
_DIM = 4


# ---------------------------------------------------------------------------
# Fake model factory (mirrors test_parse_skip.py exactly)
# ---------------------------------------------------------------------------

def _make_fake_model() -> MagicMock:
    """MagicMock whose encode() returns deterministic dim-4 L2-normalised vectors."""
